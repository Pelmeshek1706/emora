...
def crop_img(img: np.ndarray, bb_dict: BBoxDict) -> np.ndarray:
    """
    ---------------------------------------------------------------------------------------------------
...
def draw_bounding_boxes_sf(frame: np.ndarray, bb_dict: BBoxDict) -> np.ndarray:
    """
    ---------------------------------------------------------------------------------------------------
...
def calculate_padding(bb_dict: BBoxDict, padding_percent: float) -> BBoxDict:
    """
...
def resize_to_fit(img: np.ndarray, frame_size: Tuple[int, int]) -> np.ndarray:
    """
...
def blacken_outside_bounding_box(frame: np.ndarray, bb_dict: BBoxDict) -> np.ndarray:
    """
    ---------------------------------------------------------------------------------------------------
...
def create_cropped_video(
    video_path: str,
    detections: list[BBoxDict],
    output_path: str,
    crop: bool = False,
    trim: bool = True,
    debug: bool = False,
    default_size_for_cropped: Tuple[int, int] = (512, 512)
) -> None:
    """
