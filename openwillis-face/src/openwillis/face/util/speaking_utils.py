...
def get_summary(df: pd.DataFrame, start_at_col: int) -> pd.DataFrame:
    """
    ---------------------------------------------------------------------------------------------------
...
def get_fps(df: pd.DataFrame) -> int:
    """
    ---------------------------------------------------------------------------------------------------
...
def get_speaking_probabilities(df: pd.DataFrame, rolling_std_seconds: int) -> pd.Series:
    """
    ---------------------------------------------------------------------------------------------------
